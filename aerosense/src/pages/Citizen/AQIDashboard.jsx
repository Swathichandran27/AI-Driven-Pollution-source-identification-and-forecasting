...
// // // Using plain div wrappers here to avoid JSX tag mismatch during quick fixes
// // import { 
// //   MapPin, 
// //   Wind, 
// //   Droplets, 
...
//       {/* Sidebar */}
//       <aside className="w-64 fixed inset-y-0 left-0 bg-[#0F172A] border-r border-[#07101a] p-4">
//         <div className="flex items-center gap-3 mb-6">
//           <div className="w-10 h-10 bg-[#111827] rounded-lg flex items-center justify-center text-blue-400 font-semibold">AQ</div>
//           <div>
//             <h3 className="text-white font-semibold">AeroSense</h3>
//             <p className="text-xs text-gray-400">Live AQI Monitor</p>
//           </div>
//         </div>
//         <nav className="mt-6 space-y-2 text-sm">
//           <a className="block px-3 py-2 rounded-lg hover:bg-[#071526] transition-colors">Dashboard</a>
//           <a className="block px-3 py-2 rounded-lg hover:bg-[#071526] transition-colors">Stations</a>
//         </nav>
//       </aside>
...
//           <div>
//             <h1 className="text-2xl font-semibold text-white">Live AQI Monitor</h1>
//             <p className="text-sm text-gray-400">Real-time air quality for Delhi-NCR</p>
//           </div>
...
//                 className="pl-10 pr-8 py-2 rounded-lg bg-[#071526] text-gray-200 appearance-none focus:outline-none focus:ring-2 focus:ring-[#2563EB]"
...
//               <button
//                 className={`px-3 py-1 text-sm rounded-md transition-colors ${timeRange === '24h' ? 'bg-[#2563EB] text-white' : 'text-gray-300 hover:bg-[#0b1220]'}`}
//                 onClick={() => setTimeRange('24h')}
//               >
//                 24H
//               </button>
//               <button
//                 className={`px-3 py-1 text-sm rounded-md transition-colors ${timeRange === '7d' ? 'bg-[#2563EB] text-white' : 'text-gray-300 hover:bg-[#0b1220]'}`}
//                 onClick={() => setTimeRange('7d')}
//               >
//                 7D
//               </button>
//               <button
//                 className={`px-3 py-1 text-sm rounded-md transition-colors ${timeRange === '30d' ? 'bg-[#2563EB] text-white' : 'text-gray-300 hover:bg-[#0b1220]'}`}
...
//           {dataSource === 'mock' && (
//             <div className="text-xs text-yellow-300 bg-[#3b2d00] p-2 rounded">Mock data: fallback for development.</div>
//           )}

//           <section className="space-y-4">
//             <div className="flex flex-col lg:flex-row gap-4">
//               <div className="flex-1 bg-[#111827] rounded-xl p-5 shadow-sm transition-all">
//                 <div className="flex items-center gap-3">
//                   <Gauge className={getAQITextColor(data.current.aqi)} size={28} />
//                   <div>
//                     <div className="text-sm text-gray-300">Current AQI</div>
//                     <div className="flex items-baseline gap-3">
//                       <span className={`text-5xl font-bold ${getAQITextColor(data.current.aqi)}`}>{data.current.aqi}</span>
...
//                   <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-[#0b1220] ${getAQITextColor(data.current.aqi)}`}>{data.current.category}</span>
//                   <span className="ml-2 px-2 py-1 rounded text-xs bg-[#071526] text-gray-300">{dataSource === 'live' ? 'Live' : 'Mock'}</span>
//                 </div>

//                 <p className="mt-3 text-sm text-gray-400 max-w-2xl">{getAQIMessage(data.current.aqi)}</p>
//               </div>

//               <div className="w-full lg:w-96 grid grid-cols-2 gap-4">
//                 <div className="bg-[#111827] rounded-xl p-4 shadow-sm">
//                   <div className="flex items-center gap-2 mb-2">
//                     <Wind className="text-[#3B82F6]" size={18} />
//                     <span className="text-sm text-gray-300">PM2.5</span>
//                   </div>
//                   <div className="flex items-baseline gap-2">
//                     <span className="text-2xl font-semibold text-white">{data.current.pm25}</span>
...
//                   </div>
//                   <div className="flex items-baseline gap-2">
//                     <span className="text-2xl font-semibold text-white">{data.current.pm10}</span>
//                     <span className="text-sm text-gray-400">µg/m³</span>
//                   </div>
//                 </div>
...
//                   </div>
//                   <div className="flex items-baseline gap-2">
//                     <span className="text-2xl font-semibold text-white">{data.current.no2}</span>
...
//                   </div>
//                   <div className="flex items-baseline gap-2">
//                     <span className="text-2xl font-semibold text-white">{data.current.co ?? '—'}</span>
//                     <span className="text-sm text-gray-400">ppb</span>
//                   </div>
//                 </div>
//               </div>
...
//               <div className="lg:col-span-2 bg-[#111827] rounded-xl p-4 shadow-sm">
//                 <div className="flex justify-between items-center mb-3">
//                   <h2 className="text-lg font-semibold text-white">24-Hour AQI Trend</h2>
//                   <div className="flex items-center gap-2 text-sm text-gray-400"><Clock size={16} /> <span>Updated hourly</span></div>
//                 </div>
//                 <div style={{ height: 240 }}>
//                   <ResponsiveContainer width="100%" height="100%">
//                     <LineChart data={hourlyData.length ? hourlyData : data.hourly} margin={{ top: 8, right: 20, left: 0, bottom: 0 }}>
//                       <XAxis dataKey="time" tick={{ fontSize: 12 }} stroke="#9CA3AF" />
//                       <YAxis domain={[0, 'dataMax']} stroke="#9CA3AF" />
//                       <Tooltip contentStyle={{ backgroundColor: '#0B1220', border: 'none', borderRadius: '8px' }} />
...
//               <div className="bg-[#111827] rounded-xl p-4 shadow-sm">
//                 <h2 className="text-lg font-semibold text-white mb-3">Health Impact</h2>
//                 <div className="space-y-3 text-sm text-gray-300">
//                   <div className="flex items-start gap-3">
//                     <div className="w-8 h-8 bg-[#071526] rounded-lg flex items-center justify-center flex-shrink-0"><AlertTriangle className="text-red-400" size={18} /></div>
//                     <div>
//                       <p className="font-medium">Sensitive Groups</p>
//                       <p className="text-gray-400">Children, elderly, and those with respiratory issues should avoid outdoor activities.</p>
//                     </div>
//                   </div>
//                   <div className="flex items-start gap-3">
//                     <div className="w-8 h-8 bg-[#071526] rounded-lg flex items-center justify-center flex-shrink-0"><Activity className="text-yellow-400" size={18} /></div>
//                     <div>
//                       <p className="font-medium">General Public</p>
//                       <p className="text-gray-400">Reduce prolonged or heavy exertion outdoors.</p>
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//             <div className="bg-[#111827] rounded-xl p-3 shadow-sm">
...
//                 <div key={index} className="bg-[#111827] hover:shadow-md transition-shadow p-4 rounded-lg">
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Nearby Stations */}
        <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg">
          <h2 className="text-lg font-semibold text-white mb-4">Nearby Monitoring Stations</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {data.nearbyStations.map((station, index) => (
              <div key={index} className="bg-gray-700/50 hover:bg-gray-700 transition-all p-4 rounded-lg cursor-pointer">
                <div className="flex justify-between items-start mb-2">
                  <div>
                    <h3 className="font-medium text-white">{station.name}</h3>
                    <p className="text-xs text-gray-400">{station.distance || (index + 1)} km away</p>
                  </div>
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${getAQITextColor(station.aqi)}`}>
                    AQI {station.aqi}
                  </span>
                </div>
                <div className="flex gap-2 text-xs text-gray-400">
