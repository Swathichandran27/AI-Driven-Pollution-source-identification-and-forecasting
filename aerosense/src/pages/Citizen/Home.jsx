    ...
    <div className="min-h-screen bg-[#0B0F19] text-gray-200">
      <main className="p-6 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Link to="/citizen/aqi-dashboard" className="bg-[#111827] rounded-xl hover:shadow-md transition-shadow p-6">
          ...
          <Link to="/citizen/source-analysis" className="bg-[#111827] rounded-xl hover:shadow-md transition-shadow p-6">
            <div className="w-12 h-12 bg-[#071526] rounded-lg flex items-center justify-center mb-4">
          ...
          <Link to="/citizen/forecast-alerts" className="bg-[#111827] rounded-xl hover:shadow-md transition-shadow p-6">
            <div className="w-12 h-12 bg-[#071526] rounded-lg flex items-center justify-center mb-4">
          ...
          <Link to="/citizen/health-advisory" className="bg-[#111827] rounded-xl hover:shadow-md transition-shadow p-6">
            <div className="w-12 h-12 bg-[#071526] rounded-lg flex items-center justify-center mb-4">
